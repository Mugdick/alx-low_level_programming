...
/**
 * create_char_array - Creates an array of chars and initializes it with
 *                 the character.
 ...
 * @final_prod: stores the running final product.
...
int main(int argc, char *argv[])
{
	...
	final_prod = create_char_array(size + 1);
	next_prod = create_char_array(size + 1);
